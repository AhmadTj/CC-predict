...
import numpy as np # Needed to create random number generator #DONE#
from botocore.exceptions import ClientError # Catch errors on client side #DONE#
import botocore
# <<<<<   NB...!!!!  You will need to add additional libraries to complete this script 
...
def lambda_handler(event, context):
    ...
    # --- Insert your code here ---
    rid = np.random.randint(1, 1000000000) # <--- Replace this value with your code. #DONE#
    # -----------------------------
    
    # ** Instantiate the DynamoDB service with the help of the boto3 library **
    
    # --- Insert your code here ---
    dynamodb = boto3.resource('dynamodb') # <--- Replace this value with your code.  #DONE#
    # -----------------------------
    
    # Instantiate the table. Remember pass the name of the DynamoDB table created in step 4
    table = dynamodb.Table('Ahmad_Predict') #DONE#
    ...
    # --- Insert your code here ---
    db_response = table.put_item(Item={'ResponsesID': rid, # <--- Insert the correct variable #DONE#
                        'Name': dec_dict['name'], # <--- Insert the correct variable #DONE#
                        'Email': dec_dict['email'], # <--- Insert the correct variable #DONE#
                        'Cell': dec_dict['phone'], # <--- Insert the correct variable #DONE#
                        'Message': dec_dict['message'] # <--- Insert the correct variable #DONE#
    })
    ...
    # --- Insert your code here ---
    SENDER = 'ahmadtmodibbo@gmail.com'
    # -----------------------------
